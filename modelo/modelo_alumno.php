...
function list_notes_letter($curso,$alum){
$sql = "SELECT practica1, practica2, practica3, practica4, trabajo1, trabajo2, trabajo3, trabajo4, parcial1, parcial2, parcial3, parcial4, exsamen1, exsamen2 FROM letter_notes where alumnoid='$alum' and curso='$curso' ";
