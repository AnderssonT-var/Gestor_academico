        ...
        if ($_SESSION['S_ROL'] =='DOCENTE') {
         ...
         <li>
          <a onclick="cargar_contenido('contenido_principal','docente/vista_aulas_docente.php')">
           ...
           <li>
           <a onclick="cargar_contenido('contenido_principal','letter/vista_cursosgrado_listar.php')">
            <i class="fa fa-calendar"></i> <span style="cursor: pointer;">Notas alfabéticas</span>
            <span class="pull-right-container">
       ...
       <?php
        ...
        if ($_SESSION['S_ROL'] =='ALUMNO') {
          ...
          <a onclick="cargar_contenido('contenido_principal','alumno/vista_calificaciones.php')">
           ...
           <li>
          <a onclick="cargar_contenido('contenido_principal','alumno/vista_letter.php')">
            <i class=" fa  fa-edit"></i> <span style="cursor: pointer;">Notas alfabéticas</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
