<?php
   ...
   $practica3 = htmlspecialchars($_POST['practica3'] ?? '', ENT_QUOTES, 'UTF-8');
   $practica4 = htmlspecialchars($_POST['practica4'] ?? '', ENT_QUOTES, 'UTF-8');
   ...
   $trabajo4  = htmlspecialchars($_POST['trabajo4'] ?? '', ENT_QUOTES, 'UTF-8');

   $parcial1  = htmlspecialchars($_POST['parcial1'] ?? '', ENT_QUOTES, 'UTF-8');
   $parcial2  = htmlspecialchars($_POST['parcial2'] ?? '', ENT_QUOTES, 'UTF-8');
   $parcial3  = htmlspecialchars($_POST['parcial3'] ?? '', ENT_QUOTES, 'UTF-8');
   $parcial4  = htmlspecialchars($_POST['parcial4'] ?? '', ENT_QUOTES, 'UTF-8');

   $exsamen1  = htmlspecialchars($_POST['exsamen1'] ?? '', ENT_QUOTES, 'UTF-8');
   $exsamen2  = htmlspecialchars($_POST['exsamen2'] ?? '', ENT_QUOTES, 'UTF-8');

   $consulta = $docent->register_notes_letter($gradoID , $curso, $alumnoid, $practica1 ,$practica2,$practica3,$practica4, $trabajo1 , $trabajo2 , $trabajo3 , $trabajo4 , $parcial1 , $parcial2 , $parcial3 , $parcial4 , $exsamen1 ,$exsamen2);
