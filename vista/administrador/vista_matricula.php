                         ...
                         <input type="number" class="form-control" id="txt_pago" placeholder="s/." ><br>
                          ...
                          <div class="col-lg-4">
                           <label for="">C&oacute;digo</label>
                             <input type="text" class="form-control" id="txt_codig" placeholder="Ingrese Código" ><br>
                          </div>
             ...
             <!-- /.Y CANCELACION -->
              ...
              <div class="tab-pane" id="tab_3">
                 <div class="row">
                       ...
                       <input type="text" class="form-control" id="coleg_n" placeholder="COLEGIO" ><br>
                        </div> 

                        <div class="col-lg-4">
                       <label for="">Ubicaci&oacute;n geogr&aacute;fica</label>
                       <input type="text" class="form-control" id="coleg_u" placeholder="UBICACION" ><br>
                        </div> 
