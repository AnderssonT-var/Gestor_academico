...
<script type="text/javascript" src="../js/letter_notes.js?rev=<?php echo time();?>"></script>
<style>
  /* Para evitar que las etiquetas <label> se desborden */
  .nota-letra {
   text-align: center;
    padding: 5px;
  ...
  /* Estilo para columna promedio */
  td strong {
    font-size: 15px;
  }

  /* Opcional: colorear las letras directamente (en la vista) */
  .nota-letra-red {
    color: red;
  }
            ...
            <input type="text" name="" id="idalumno" hidden>
              ...
              <div class="col-lg-6" style="display: flex;">
                ...
                <div class="col-lg-5">
                   ...
                   <input type="text" class="form-control" id="practica1" style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">Práctica 2:</label>
                   <input type="text" class="form-control" id="practica2"  style="border-radius: 5px" oninput="validarABC(this)"><br>
               ...
               <div class="col-lg-5">
                   ...
                   <input type="text" class="form-control" id="trabajo1"  style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">Trabajo 2:</label>
                   <input type="text" class="form-control" id="trabajo2"  style="border-radius: 5px" oninput="validarABC(this)"><br>
               ...
               <div class="col-lg-5">
                   ...
                   <input type="text" class="form-control" id="parcial1"  style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-5">
                   <label for="">Parcial 2:</label>
                   <input type="text" class="form-control" id="parcial2"  style="border-radius: 5px" oninput="validarABC(this)"><br>
               ...
               <div class="col-lg-6">
                    ...
                    <input type="text" class="form-control" id=exsamen1 style="border-radius: 5px" oninput="validarABC(this)"><br>
                </div>
                <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;EF-20%</span>
                    <input type="text" class="form-control" id="exsamen2" style="border-radius: 5px" oninput="validarABC(this)"><br>
                </div>
            ...
            <input type="text" name="" id="edit_idalumno"  hidden>
             <input type="text" name="" id="id_tablenota"  hidden>
              ...
              <div class="col-lg-6" style=" display: flex;">
                ...
                <div class="col-lg-3">
                   <label for="">Práctica 1:</label>
                   <input type="text" class="form-control" id="edit_practica1" disabled style="border-radius: 5px" oninput="validarABC(this)"><br>
  
               </div>
                <div class="col-lg-3">
                   <label for="">Práctica 2:</label>
                   <input type="text" class="form-control" id="edit_practica2"  disabled style="border-radius: 5px" oninput="validarABC(this)"><br>
                   
               </div>
                   <div class="col-lg-3">
                   <label for="">Práctica 3:</label>
                   <input type="text" class="form-control" id="edit_practica3" style="border-radius: 5px" oninput="validarABC(this)"><br>
  
               </div>
                <div class="col-lg-3">
                   <label for="">Práctica 4:</label>
                   <input type="text" class="form-control" id="edit_practica4" style="border-radius: 5px" oninput="validarABC(this)"><br>
               ...
               <div class="col-lg-3">
                   <label for="">Trabajo 1:</label>
                   <input type="text" class="form-control" id="edit_trabajo1"  disabled style="border-radius: 5px"oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-3">
                   <label for="">Trabajo 2:</label>
                   <input type="text" class="form-control" id="edit_trabajo2"  disabled style="border-radius: 5px"oninput="validarABC(this)"><br>
                   
               </div>

                <div class="col-lg-3">
                   <label for="">Trabajo 3:</label>
                   <input type="text" class="form-control" id="edit_trabajo3" style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-3">
                   <label for="">Trabajo 4:</label>
                   <input type="text" class="form-control" id="edit_trabajo4" style="border-radius: 5px" oninput="validarABC(this)"><br>
              ...
              <div class="col-lg-12">
               <div class="col-lg-3">
                   <label for="">Parcial 1:</label>
                   <input type="text" class="form-control" id="edit_parcial1"  disabled style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-3">
                   <label for="">Parcial 2:</label>
                   <input type="text" class="form-control" id="edit_parcial2"  disabled style="border-radius: 5px" oninput="validarABC(this)"><br>
                   
               </div>

               <div class="col-lg-3">
                   <label for="">Parcial 3:</label>
                   <input type="text" class="form-control" id="edit_parcial3" style="border-radius: 5px" oninput="validarABC(this)"><br>
                    
               </div>
                <div class="col-lg-3">
                   <label for="">Parcial 4:</label>
                   <input type="text" class="form-control" id="edit_parcial4" style="border-radius: 5px" oninput="validarABC(this)"><br>
               ...
               <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;MC-20%</span>
                    <input type="text" class="form-control" id=edit_exsamen1 style="border-radius: 5px" oninput="validarABC(this)"><br>
                </div>
                <div class="col-lg-6">
                    <label for="">Exsamen</label><span class='label label-success'>&nbsp;EF-20%</span>
                    <input type="text" class="form-control" id="edit_exsamen2" style="border-radius: 5px" oninput="validarABC(this)"><br>
                </div>
