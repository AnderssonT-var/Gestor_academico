  ...
  <div class="box box-warning ">
    <div class = "box-header with-border titulosclass" id="Titulo_Center"  >
      <h5 class = "box-title" ><strong>Registro de asistencia</strong></h5>
       <div class="box-tools pull-right">
         <button type="button" class="btn btn-box-tool" data-widget="remove"  title="" data-original-title="Remove" onclick="reset_sedebar();">
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-3">
          <label >Seleccione Grado</label>
           <select class="js-example-basic-single cmb_cousesId" name="state"  style="width:100%;" onchange="ShowSelected('cmb_cousesId');"  >
              </select>
        </div>
        <div class="col-md-3" >
           <label>Nivel/Grado</label>
           
               <input type="text" name="" class="id_grade" id="" hidden>
              <input type="text" name="" class="form-control text_name_grade"  disabled>
     ...
     <div class="modal-footer">
       ...
       <button class="btn btn-primary btn-sm" id="button_resgist" onclick="asignar_attendance()"><em class="fa fa-check"><b>&nbsp;Registrar</b></em></button>
     </div>
   </div>
 </div>
</div>
 ...
 <div class="box box-warning ">
  ...
  <div class="box-body">
   <div class="row">
        ...
        <div class="col-md-3">
          <label >Seleccione Grado</label>
           <select class="js-example-basic-single cmb_cousesId_edit"  style="width:100%;" onchange="ShowSelected('cmb_cousesId_edit');"   >
              </select>
        </div>
        <div class="col-md-3" >
           <label>Nivel</label>
...
<div class="row">
        ...
        <div class="col-md-3">
          <label >Seleccione Grado</label>
           <select class="js-example-basic-single cmb_cousesId_remove"  style="width:100%;" onchange="ShowSelected('cmb_cousesId_remove');"  >
              </select>
        </div>
        <div class="col-md-3" >
...
<div class="modal-footer">
   <img class="loader" src="../login/vendor/abc.gif" style="width: 50px;height:50px;display: none;">&nbsp;
 <button class="btn btn-danger btn-sm" id="elim_button_resgist" onclick="Elimirar_Asistencia();"><em class="fa fa-trash-o" ></em> Eliminar</button>
