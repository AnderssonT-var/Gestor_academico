...
$usuario = 'root';
$password = '';
$db = new PDO('mysql:host=localhost;dbname=sistemacursov4', $usuario, $password);
     ...
     margin-left: 40%; 
          ...
          <div class="panel-body">
            ...
            <div class="table-responsive" style="justify-content: center;">
              ...
              $array = array("CÓDIGO","APELLIDOS ","NOMBRES ","DNI","GRADO ", "SEXO ","ESTADO " ,"FECHA","DIRECCIÓN");
