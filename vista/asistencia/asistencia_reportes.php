          ...
          <div class="row">
            ...
            <div class="col-xs-3">
              ...
              <input type="date" class="form-control" id="reportFechafin" placeholder="" style="border-radius: 5px;" > &nbsp;
						<button onclick="reports_attendance();" class="btn " type="submit" name="search" id="but_alin_global" class="btn btn-flat" style="font-size: 10px; background-color: #05ccc4; color: white">
